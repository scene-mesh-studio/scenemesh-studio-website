...
**Entity (实体)**  
Entity Engine 的核心概念，表示具有标识的业务对象。

**Entity Manager (实体管理器)**  
负责实体生命周期管理的核心组件，提供 CRUD 操作接口。
...
**Field (字段)**  
实体的数据属性，具有特定的类型和验证规则。

**Filter (过滤器)**  
用于筛选数据的条件表达式或函数。

**Foreign Key (外键)**  
指向另一个实体主键的引用，用于建立实体间的关联关系。
