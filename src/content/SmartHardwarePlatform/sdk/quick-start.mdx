...
- ✅ **ESP-IDF 5.0+** - [安装指南](https://docs.espressif.com/projects/esp-idf/zh_CN/latest/esp32s3/get-started/)
...
1. 下载 [最新版本](https://github.com/streamind/sdk-prebuilt/releases)
...
// 平台认证信息（从开发配置菜单获取）
#define spaceId "tenant_001"
#define neuronId "product_001"
...
- **Component config → LWIP** → `TCP/IP Task Stack Size` = 8192
...
（macOS 用户通常使用 `/dev/tty.usbserial-*` 或 `/dev/tty.SLAB_USBtoUART`）
...
esp_log_level_set("*", ESP_LOG_INFO);  // 其他模块
```
...
- 📖 [完整 API 文档](./api-reference/sdk-class)
- 💬 [GitHub Discussions](https://github.com/streamind/sdk/discussions)
- 🐛 [问题反馈](https://github.com/streamind/sdk/issues)
- 💡 [示例代码](./examples/audio-integration)

---

**🎉 恭喜！你已成功集成 StreamInd SDK！**

继续阅读 [核心概念](./core-concepts) 深入了解 Signal-Directive 架构。
