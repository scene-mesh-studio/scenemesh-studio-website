            ...
            >
              ...
              <motion.div
                style={{
                  ...
                  fontWeight: 600,
                  marginBottom: '12px',
                  background: isActive ? theme.colors.blue[500] : theme.colors.neutral[200],
                  color: isActive ? 'white' : theme.colors.neutral[500]
                }}
                className={isActive ? '' : 'bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400'}
                animate={{
                  background: isActive ? theme.colors.blue[500] : theme.colors.neutral[200],
                  boxShadow: index === currentStep ? '0 0 20px rgba(59, 130, 246, 0.4)' : 'none'
                }}
              >
                {index + 1}
              </motion.div>
...
// 核心特性展示 - 网格卡片布局（首页风格）
const CoreFeatures = ({ isDark }: { isDark: boolean }) => {
  const features = [
    {
      title: '元数据驱动架构',
          ...
          <div 
            ...
            <div style={{
              ...
              <div style={{
                ...
                flexDirection: 'column',
                justifyContent: 'center',
                borderRight: `0.5px solid ${isDark ? '#444444' : '#E5E7EB'}`
              }}>
                {/* 主标题 */}
                <h1
                  className="text-gray-900 dark:text-gray-100"
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                  <Button size="md" onClick={() => window.location.href = '/docs/entityengine'}>
                    快速开始
                  ...
                  <Button 
                    variant="secondary" 
                    size="md" 
                    onClick={() => window.open('https://github.com/scenemesh/entity-engine', '_blank')}
                  >
                    GitHub
                  </Button>
                </div>
...
// 自动生成表单、表格、详情页面`}</code>
      ...
      <footer 
        style={{
          ...
          backgroundColor: isDark ? 'rgb(31 41 55)' : 'rgb(243 244 246)', // 深色模式: gray-800, 浅色模式: gray-100
        }}>
        ...
        <div style={{ 
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {[
                  ...
                  { name: 'GitHub仓库', href: 'https://github.com/scenemesh/entity-engine' },
                  { name: '返回首页', href: '/' }
                ].map((link, index) => (
                  <a
                    key={index}
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {[
                  ...
                  { name: '问题反馈', href: 'https://github.com/scenemesh/entity-engine/issues' },
                  { name: '贡献指南', href: 'https://github.com/scenemesh/entity-engine/blob/main/CONTRIBUTING.md' },
                  { name: '更新日志', href: 'https://github.com/scenemesh/entity-engine/releases' }
                ].map((link, index) => (
                  <a
                    key={index}
                    href={link.href}
          ...
          <div 
            ...
            <div 
              ...
              © 2025 SceneMesh Entity Engine • 基于MIT协议开源
            </div>
          </div>
        </div>
      </footer>
