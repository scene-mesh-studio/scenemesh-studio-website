...
// 工作室产品展示组件 - 简洁网格设计
const StudioProducts: React.FC<{ isDark: boolean }> = ({ isDark }) => {
  const products = [
    {
      id: 'scenemesh',
      title: 'Stremind',
...
// 工作室理念展示组件
const StudioPhilosophyGrid = ({ isDark }: { isDark: boolean }) => {
  const philosophies = [
    {
      title: '原生AI能力',
  ...
  return (
    <div 
      ...
      <div 
        ...
        style={{
          display: 'grid',
          gridTemplateColumns: '2fr 1.2fr 1.3fr',
        ...
        {philosophies.map((philosophy, index) => {
          ...
          return (
            <motion.div
              ...
              className="bg-white dark:bg-gray-800"
              style={{
                padding: config.isLarge ? '56px 48px' : config.isWide ? '40px 48px' : '40px 32px',
                position: 'relative',
    ...
    <div 
      ...
      >
        ...
        >
          ...
          >
            <Button size="lg" onClick={() => window.location.href = '/docs'}>
              立即开始
            ...
            <Button 
              variant="ghost" 
              size="lg" 
              onClick={() => window.open('https://github.com/scenemesh', '_blank')}
            >
      ...
      <section 
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <StudioPhilosophyGrid isDark={isDark} />
        </div>
      </section>
        ...
        <div style={{ 
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {[
                  ...
                  { name: '开源项目', href: 'https://github.com/scenemesh' },
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {[
                  { name: 'GitHub', href: 'https://github.com/scenemesh' },
                  { name: 'Twitter', href: 'https://twitter.com/scenemesh' },
                  { name: '微信群', href: '/wechat' },
                  { name: 'QQ群', href: '/qq' }
                ].map((link, index) => (
                  <a
                    key={index}
          ...
          <div 
            ...
            <div 
              ...
              © 2025 SceneMesh Studio 基于MIT协议开源
            </div>
          </div>
        </div>
      </footer>
